...
public class Reporter : MonoBehaviour
{
	...
	public void Initialize()
	{
		...
		{
			Debug.LogWarning("An instance of Reporter already existed, destroying new instance.");
	...
	void Start()
	{
		...
		SceneManager.sceneLoaded += (scene, mode) => HandleLevelLoaded();
	}
	...
	public void doShow()
	{
        show = true;
        currentView = ReportView.Logs;
        gameObject.GetComponent<ReporterGUI>().enabled = true;
